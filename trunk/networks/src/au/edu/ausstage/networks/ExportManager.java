...
public class ExportManager {
	...
	public String getSimpleNetwork(String id, String formatType, int degrees, String graphType) {
		...
		if(formatType.equals("graphml") == true) {
			...
			dataString = buildDebugFile(collaborators, graphType);
		}
	 ...
	 */
	private String buildDebugFile(java.util.TreeMap<Integer, Collaborator> collaborators, String graphType) {
	
		// declare a string builder used to collate the output
		StringBuilder dataToReturn = new StringBuilder();
		
		// add some additional information
		dataToReturn.append("# Graph generated on: " + DateUtils.getCurrentDateAndTime() + "\n");
		dataToReturn.append("# Graph generated by: " + database.getContextParam("systemName") + " Version: " + database.getContextParam("systemVersion") + " Build: " + database.getContextParam("buildVersion") + "\n");
		dataToReturn.append("# Graph Type: " + graphType + "\n");
