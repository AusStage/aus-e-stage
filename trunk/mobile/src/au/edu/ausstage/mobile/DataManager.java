...
public class DataManager {
	...
	public void connect() throws java.sql.SQLException {
		...
		try {
			...
			throw new java.sql.SQLException("Unable to connect to Database", sqlEx);
		}	
	} // end connect Method
	 ...
	 */
	public java.sql.ResultSet executeStatement(String sqlQuery) throws java.sql.SQLException {
		...
		try {
			...
			throw new java.sql.SQLException("Unable to execute an SQL Query", sqlEx);
		}
	 ...
	 * @return           the result set built from executing this query
	 */
	public java.sql.ResultSet executePreparedStatement(String sqlQuery, String[] parameters) throws java.sql.SQLException {
