...
public class XMLDataManager {
	...
	/**
	 * A method to execute an XPath expression against a supplied XML file
	 *
	 * @param xmlFile the XML file to execute the XPath expression against
	 * @param xpath   the XPath expression to execute
	 *
	 * @return the results of the query
	 */
	public String executeQuery(File xmlFile, String xpath) {
